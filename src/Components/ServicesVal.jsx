...
const ServicesVal = () => {
  return (
    ...
    <div className="card grid md:grid-cols-2 xl:grid-cols-2  lg:grid-cols-2 sm:grid-cols-1 xl:px-40  lg:px-24 sm:px-5 gap-2 sm:gap-1  w-full overflow-x-hidden" id='ServicesVal'>
